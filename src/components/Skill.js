    ...
    <div ref={ref} className="relative bottom-10 bg-amber-100 pb-16 ">
      <div className="mx-80">
        ...
        <div className= "flex flex-col items-center bg-white  rounded-xl shadow-xl p-5">
          <p className="text-3xl text-blue-400 mt-2 mb-10 font-extrabold">Frontend</p>
        ...
        <div className="flex justify-between mt-16 gap-14">
          <div className="flex flex-col items-center p-5 bg-white rounded-xl shadow-xl">
            <p className="text-3xl text-blue-400 mt-2 mb-10 font-extrabold ">Deploy</p>
            <img className="w-[70%]" src={DeployImg} />
          </div>
          <div className="flex flex-col items-center p-5 bg-white rounded-xl shadow-xl">
            <p className="text-3xl text-blue-400 mt-2 mb-10 font-extrabold">Version Control</p>
            <img src={VersionImg} className="w-[82%]" />
          </div>
          <div className="flex flex-col items-center p-5 bg-white rounded-xl shadow-xl">
            <p className="text-3xl text-blue-400 mt-2 mb-10 font-extrabold">certificate</p>
